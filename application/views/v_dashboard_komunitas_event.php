	...
	<div class="container-fluid" id="ctn">
		<div class="row section">
			...
			<div class="col-md-8 db-content">
				<h2 class="font-gotham-bold font-md">Event Komunitas</h2>
				<a href="#" class="button btn-green db-float-button font-xs" data-toggle="modal" data-target="#"><i class="fa fa-plus"></i> Tambah Event</a>
				...
				<table class="table table-striped">
					...
					?>
						<tr>
							...
							<td><?php echo $event->kota ?></td>
							<td class="font-white">
								<a href="<?php echo base_url('event/'.$event->permalink) ?>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Lihat"><i class="fa fa-eye"></i></a>
								<a href="#" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Sunting"><i class="fa fa-edit"></i></a>
								<a href="<?php echo base_url('crud/delete/event/'.$event->id_event) ?>" onclick="return confirm('yakin ingin menghapus?')" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
					<?php } ?>
				</table>
